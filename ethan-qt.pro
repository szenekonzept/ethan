...
contains(ETHAN_NEED_QT_PLUGINS, 1) {
    DEFINES += ETHAN_NEED_QT_PLUGINS
...
HEADERS += src/qt/ethangui.h \
    ...
    src/qt/ethanaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/ethan.cpp src/qt/ethangui.cpp \
    ...
    src/qt/ethanaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/ethanstrings.cpp \
    src/qt/ethanamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/ethan.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/ethan_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/ethan-qt.rc
...
windows:RC_FILE = src/qt/res/ethan-qt.rc
...
macx:ICON = src/qt/res/icons/ethan.icns
macx:TARGET = "ethan-Qt"
