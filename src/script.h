...
#ifndef H_ETHAN_SCRIPT
#define H_ETHAN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEthanAddress
 */
...
public:
    ...
    // Pre-version-0.6, Ethan always counted CHECKMULTISIGs
